...
export async function GET(request: Request) {
  ...
  return new NextResponse(html, {
    headers: {
      ...
      "Content-Disposition": `inline; filename="LifeVault_Summary_${generatedDate.replace(/\s/g, '_')}.html"`,
    },
  });
}
...
<head>
  <meta charset="UTF-8">
  <title>LifeVault Summary - ${profile?.first_name} ${profile?.last_name}</title>
  <style>
...
<body>
  ...
  <div class="footer">
    <p>Generated by LifeVault &middot; lifevault.com.au &middot; Secure end-of-life planning for Australian families</p>
